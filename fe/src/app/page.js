              ...
              <div className="px-6">
                ...
                <div className="text-center mt-12">
                  <h3 className="text-4xl font-semibold leading-normal mb-2 text-gray-800 mb-2">
                    Matanuska Froniter Trek
                  </h3>
                  <div className="text-sm leading-normal mt-0 mb-2 text-gray-500 font-bold uppercase">
                    <i className="fas fa-map-marker-alt mr-2 text-lg text-gray-500"></i>{" "}
                    <a
                      target="_blank"
                      href="https://earth.google.com/web/search/palmer,+alaska/@61.62387636,-149.07089626,162.09217654a,13511.64447346d,35y,173.52647721h,60.04914728t,-0r/data=CigiJgokCT1PLZzWK0VAEdZnlMUAfjBAGckm9A1R62JAIddLONADOVvA"
                      rel="noreferrer"
                    >
                      Palmer, Alaska
                    </a>
